...
public:
    ...
    /** Register touch events handler */
	inline void setTouchHandler(CCTouchDelegate *nHandler){ m_uTouchHandler = nHandler;};
...
private:
	...
	CCTouchDelegate* m_uTouchHandler;
    ...
    int executeTouchHandler(int nEventType, CCTouch *pTouch);
};
