...
function MapGridView:ctor()
    ...
    self.blockBatch = CCSpriteBatchNode:create("images/block.png", 2000)
    self.view:addChild(self.blockBatch)
    self.linesBatch = CCSpriteBatchNode:create("images/line.png", 2000)
...
function MapGridView:addLine(edgeId)
    local line = UI.createSpriteWithFile("images/line.png", CCSizeMake(self.sizeX/2+10, self.sizeY/2+7))
...
function MapGridView:addBlock(x, y)
    ...
    local sprite = UI.createSpriteWithFile("images/block.png", CCSizeMake(self.sizeX+2, self.sizeY+2))
