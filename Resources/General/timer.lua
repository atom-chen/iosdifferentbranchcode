...
do
    ...
    local function synLocalTime(oldT, delta)
        if math.abs(gameTime - oldT - delta)>5 then
    ...
    timer = {getTime = getTime, setServerTime=setServerTime, getServerTime=getServerTime, synLocalTime=synLocalTime}
