...
function ZombieResultDialog:ctor(result)
    ...
    temp = UI.createButton(CCSizeMake(169, 65), display.popScene, {callbackParam=PreBattleScene, image="images/buttonGreen.png", text=StringManager.getString("buttonReturnHome"), fontSize=22+BIGGER_SIZE_OFF, fontName=General.font3, lineOffset=-12})
    ...
    temp = UI.createLabel(StringManager.getString("damagePercent2"), General.font2, 15+NORMAL_SIZE_OFF, {colorR = 255, colorG = 255, colorB = 255})
