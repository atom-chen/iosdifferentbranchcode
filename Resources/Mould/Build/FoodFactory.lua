...
function FoodFactory:getBuildView()
    ...
    elseif level>=6 then
        if CCTextureCache:sharedTextureCache():addImage("images/build/" .. bid .. "/bottom" .. bid .. "_6.png") then
            bbottom = UI.createSpriteWithFile("images/build/" .. bid .. "/bottom" .. bid .. "_6.png")
        else
