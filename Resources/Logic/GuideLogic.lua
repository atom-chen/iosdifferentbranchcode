...
local GuideShowTypes = {{{2, 1}, {3,2}, {1,3}}, {}, {{2,4},{2,14},{2,15},{2,5}}, {{2,6}}, {{2,7}}, {{2,8}}, {{2,9}}, {{2,10}}, {{2,11}}, {}, {}, {{2,12}}, {{2,13}}}
...
function GuideLogic.nextAnimate(isDelay)
    ...
    elseif showType[2]==14 then
        EventManager.sendMessage("EVENT_GUIDE_STEP", {"menu", "zombie"})
    elseif showType[2]==15 then
        EventManager.sendMessage("EVENT_GUIDE_STEP", {"build", 1004})
    elseif showType[2]==5 then
        GuideLogic.clearPointer()
    end
    return true
end
